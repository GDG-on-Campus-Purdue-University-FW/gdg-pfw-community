...
GDG on Campus Purdue University Fort Wayne is part of the **Google Developer Groups on Campus program**, a global initiative that supports university communities focused on applied technical learning and collaboration.

Our community welcomes students from all backgrounds and skill levels. Whether someone is a beginner learning programming for the first time or an experienced developer exploring new technologies, our events are designed to support learning through collaboration.
...
- `CODE_OF_CONDUCT.md` — Community behavior expectations and reporting guidelines
- `INCLUSIVITY_GUIDELINES.md` — Principles for creating accessible and inclusive events
- `EVENT_GUIDELINES.md` — Standards for organizing community events

These documents help ensure that our community remains welcoming, safe, and accessible to all participants.
